  ...
  return(
    <View className="w-full flex-row gap-4">
      ...
      <View className="flex-1">
        ...
        <Text className="text-base font-subtitle text-gray-400" numberOfLines={1} lineBreakMode="tail">
          {data.subject}
        </Text>

        <View className="flex-row items-center gap-4">
          <Text className="text-sm font-body text-gray-400 flex-1" numberOfLines={1} lineBreakMode="tail">
            {data.message}
          </Text>
